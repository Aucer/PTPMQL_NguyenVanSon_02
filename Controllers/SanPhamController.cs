...
namespace NguyenVanSon_02.Controllers
{
    public class SanPhamController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaSanPham,TenSanPham,MaNCC")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaSanPham,TenSanPham,MaNCC")] SanPham sanPham)
        {
